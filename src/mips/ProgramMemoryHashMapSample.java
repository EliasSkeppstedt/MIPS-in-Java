...
public class ProgramMemoryHashMapSample {
    private HashMap<ArrayKey, String> programMemoryHashMap;

    public ProgramMemoryHashMapSample() {
        programMemoryHashMap = new HashMap<>();
        initializeHashMap();
    }

    public void initializeHashMap() {
        programMemoryHashMap.put(
    ...
    public String getInstruction(int[] address) {
        return programMemoryHashMap.getOrDefault(new ArrayKey(address), "Instruction not found");
    }
